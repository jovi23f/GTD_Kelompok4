...
ENDPOINTS = [
    # "/events?page=1&limit=5&iyear=2005&region_name=South%20Asia&sortby=iday&order=asc",
    "/groups?page=1&limit=5&sortby=name&order=asc",
    # "/weapons?page=1&limit=5&sortby=type&order=desc",
    # "/targets?page=1&limit=5&sortby=name&order=asc",
    # "/regions?page=1&limit=5&sortby=name&order=asc",
    # "/countries?page=1&limit=5&sortby=name&order=asc",
    # "/attacks?page=1&limit=5&sortby=date&order=asc"
]
...
def save_results(stage_name):
    ...
    with open("loadtest_endpoint2_results.csv", "a", newline="") as csvfile:
